...
describe('SymbolTokenController (e2e)', () => {
  ...
  describe('Demo - collect providers with string token type', () => {
    it("Get all types of animals (@CustomInject(ANIMAL_PROVIDER, { multi: true, propertyName: 'type' }))", () => {
      return request(app.getHttpServer())
        .get('/symbol-token/animal-types-with-inject')
        .expect(200)
    ...
    it('What says all animals (customInjectorService: CustomInjectorService)', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/what-says-animals')
        .expect(200)
        .expect([
          'dog say woof',
          'cat say meow',
    ...
    it('What says all animals (@Inject(ANIMAL_PROVIDER))', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/what-says-animals-original')
        .expect(200)
        .expect('cat say meow');
    });
    ...
    it('What says all animals (@CustomInject(ANIMAL_PROVIDER, { multi: true }))', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/what-says-animals-with-inject')
        .expect(200)
        .expect([
          'dog say woof',
          'cat say meow',
    ...
    it('What says all animals (@CustomInjector())', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/what-says-animals-with-injector')
        .expect(200)
        .expect([
          'dog say woof',
          'cat say meow',
    ...
    it('Who say (customInjectorService: CustomInjectorService)', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/who-say?voice=baa')
        .expect(200)
    ...
    it('Error in request who say (customInjectorService: CustomInjectorService)', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/who-say?voice=gav')
        .expect(200)
    ...
    it("Who say (@Query('voice', CheckAnimalTypePipe)", () => {
      try {
        return request(app.getHttpServer())
          .get('/symbol-token/who-say-with-validate-type?voice=baa')
          .expect(200)
          .expect('sheep say baa');
      } catch (err) {
        console.log(err);
    ...
    it("Error in request who say (@Query('voice', CheckAnimalTypePipe)", () => {
      try {
        return request(app.getHttpServer())
          .get('/symbol-token/who-say-with-validate-type?voice=gav')
          .expect(400)
          .expect({
            statusCode: 400,
    ...
    it('Who say (@Inject(ANIMAL_PROVIDER))', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/who-say-original?voice=baa')
        .expect(200)
    ...
    it('Who say (@CustomInject(ANIMAL_PROVIDER, { multi: true }))', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/who-say-with-inject?voice=baa')
        .expect(200)
        .expect('sheep say baa');
    });
    ...
    it('Error in request who say (@CustomInject(ANIMAL_PROVIDER, { multi: true }))', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/who-say-with-inject?voice=gav')
        .expect(200)
        .expect({ error: `I don't know who say gav` });
    });
    ...
    it('Who say (@CustomInjector())', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/who-say-with-injector?voice=baa')
        .expect(200)
        .expect('sheep say baa');
    });
    ...
    it('Error in request who say (@CustomInjector())', () => {
      return request(app.getHttpServer())
        .get('/symbol-token/who-say-with-injector?voice=gav')
        .expect(200)
        .expect({ error: `I don't know who say gav` });
    });
  });
